...
<html lang="en">
  ...
  <head>
    ...
    <title>Mini Things Administration </title>
    ...
    <!-- NProgress -->
    <link href="<?= base_url();?>/assets/admin/nprogress/nprogress.css" rel="stylesheet">
    <!-- bootstrap-progressbar -->
    <link href="<?= base_url();?>/assets/admin/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- bootstrap-daterangepicker -->
    <link href="<?= base_url();?>/assets/admin/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
    
    <!-- Custom Theme Style -->
    <link href="<?= base_url();?>/assets/admin/custom.min.css" rel="stylesheet">
  </head>
...
<!-- Sidebar ====================================================================== --> 
    ...
    <!-- Sidebar Header Ends ====================================================================== -->
        <br />
    <!-- Sidebar Main ====================================================================== -->
        <?php include('adminPages/sidebar.php'); ?>
    <!-- Sidebar Main Ends ====================================================================== -->
    <!-- Sidebar Footer ====================================================================== -->
        <?php include('adminPages/sidebarFooter.php'); ?>
    <!-- Sidebar Footer Ends ====================================================================== -->
      </div>
    </div>
<!-- Sidebar Ends ====================================================================== -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <?php echo "<img src='" . base_url('/assets/images/admin/') . $image . "'alt=''>" . $user; ?>
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="javascript:;"> Profile</a></li>
                    <li><a href="<?= site_url('Login_controller/logout')?> "><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
              </ul>
            </nav>
    ...
    <!-- Chart.js -->
    <script src="<?= base_url() ?>/assets/admin/Chart.js/dist/Chart.min.js"></script>
    <!-- jQuery Sparklines -->
    ...
    <!-- gauge.js -->
    <script src="<?= base_url() ?>/assets/admin/gauge.js/dist/gauge.min.js"></script>
    <!-- bootstrap-progressbar -->
    <script src="<?= base_url() ?>/assets/admin/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
    <!-- Skycons -->
    <script src="<?= base_url() ?>/assets/admin/skycons/skycons.js"></script>
    <!-- Flot -->
    <script src="<?= base_url() ?>/assets/admin/Flot/jquery.flot.js"></script>
    <script src="<?= base_url() ?>/assets/admin/Flot/jquery.flot.pie.js"></script>
    <script src="<?= base_url() ?>/assets/admin/Flot/jquery.flot.time.js"></script>
    <script src="<?= base_url() ?>/assets/admin/Flot/jquery.flot.stack.js"></script>
    <script src="<?= base_url() ?>/assets/admin/Flot/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="<?= base_url() ?>/assets/admin/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="<?= base_url() ?>/assets/admin/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="<?= base_url() ?>/assets/admin/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
    <script src="<?= base_url() ?>/assets/admin/DateJS/build/date.js"></script>
    <!-- bootstrap-daterangepicker -->
